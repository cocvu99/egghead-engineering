...
## 🚀 Mission
The goal is not just to write code, but to understand **how things work under the hood**.
Instead of just reading engineering blogs, I aim to **rebuild** the concepts discussed in them—whether it's writing a firewall rule engine in Lua/Rust or simulating a distributed system failure.
